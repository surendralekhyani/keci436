...
<head>
	...
	<link href="<?php echo base_url(); ?>/public/images/diamond.png" rel="shortcut icon" type="image/x-icon" />
...
<body>
	...
	<div class="module form-module">
		...
		<div class="form">
			...
			?>
			<input type="text" id="txtUID" name="txtUID" value="<?= old('txtUID');?>" maxlength="20" placeholder="Username" autofocus autocomplete="off" />
			<input type="password" id="txtPassword" name="txtPassword" value="<?= old('txtPassword');?>" maxlength="20" placeholder="Password" autocomplete="off" />
